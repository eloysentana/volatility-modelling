...
The PDF file containing the explanations, plots and results is this [Volatility Modelling and Regime Classification Methods.pdf](https://github.com/eloysentana/volatility-modelling/blob/main/Volatility%20Modeling%20and%20Regime%20Classification.pdf)
